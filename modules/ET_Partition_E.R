...
## specifically partitions all ET to E. This will get more sophisticated
## eventually. Assumes no transpiration. Assumes no evaporative loss 
## from interception.
## 
...
ET_Partition_E <- R6Class(
  classname="ET_Partition_E",
  public = list(
    soilModData = NULL, 
    mod_data_loc = NULL,
    ...
    setUp = function() {
      ...
      self$soilModData$t_dat$PE <- dat_in$ET
    },
